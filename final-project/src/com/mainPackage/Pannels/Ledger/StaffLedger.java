 ...
 * @author Bladestorm
 */
public class StaffLedger extends javax.swing.JPanel {
    ...
    public StaffLedger() {
        ...
        List<String> staffmodel = stafflddao.getStaffname();
        Iterator<String> ls = staffmodel.iterator();
        int i = 1;
        while(ls.hasNext()){
            model.addRow(new Object[]{i,ls.next()});
            i++;
        }
    ...
    private void btnDetailsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDetailsMouseClicked
        ...
        try {
            DefaultTableModel model = (DefaultTableModel) table.getModel();
            String sStaffName = model.getValueAt(table.getSelectedRow(), 1).toString();
           MainProgram.mainframe.mainPane.remove(this);
            MainProgram.mainframe.mainPane.add(new staffLedgerDetails(sStaffName));
            SwingUtilities.updateComponentTreeUI(MainProgram.mainframe.mainPane);

        } catch (ArrayIndexOutOfBoundsException ex) {
            JOptionPane.showMessageDialog(null, "Select Staff Name");
        }
