 ...
 * @author Bladestorm
 */
public class SalesLedger extends javax.swing.JPanel {
    ...
    public SalesLedger() {
        ...
        List<SaleEntryModel> salelist = saledao.getClientDetails();
        Iterator<SaleEntryModel> iterator = salelist.iterator();
        int a = 1;
        while (iterator.hasNext()) {
            SaleEntryModel salemodel = iterator.next();
            model.addRow(new Object[]{a, salemodel.getClientname(), salemodel.getAddress()});
            a++;
        }
    ...
    private void btnDetailsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDetailsMouseClicked
        ...
        try {
            ...
            MainProgram.mainframe.mainPane.remove(this);
            MainProgram.mainframe.mainPane.add(new SalesLedgerDetails(sCompanyName, sAddress));
            SwingUtilities.updateComponentTreeUI(MainProgram.mainframe.mainPane);
